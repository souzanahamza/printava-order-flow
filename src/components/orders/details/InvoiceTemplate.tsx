            ...
            <div ref={ref} className="w-[210mm] min-h-[297mm] p-12 bg-white text-slate-900 font-sans mx-auto">
                ...
                {(companyProfile?.bank_name || companyProfile?.account_number) && (
                    <div className="mb-8 p-4 bg-slate-50 rounded-lg border border-slate-100">
                        <h4 className="text-[10px] uppercase tracking-wider font-bold text-slate-500 mb-3">Bank Details:</h4>
                        <div className="text-xs text-slate-700 grid grid-cols-2 gap-y-2 gap-x-8">
                            ...
                            {companyProfile.account_number && (
                                <div className="flex gap-2">
                                    ...
                                    <span className="font-medium">{companyProfile.account_number}</span>
                                </div>
                            )}
