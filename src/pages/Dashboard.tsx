...
const recentOrders = [
  { id: "ORD-1234", client: "Acme Corp", product: "Business Cards", status: "production" as const, date: "2025-11-14" },
  { id: "ORD-1235", client: "Tech Start", product: "Banners", status: "design" as const, date: "2025-11-14" },
  { id: "ORD-1236", client: "Local Cafe", product: "Menus", status: "shipping" as const, date: "2025-11-13" },
  { id: "ORD-1237", client: "Real Estate Co", product: "Flyers", status: "new" as const, date: "2025-11-13" },
  { id: "ORD-1238", client: "Fashion Brand", product: "Catalogs", status: "delivered" as const, date: "2025-11-12" },
];
